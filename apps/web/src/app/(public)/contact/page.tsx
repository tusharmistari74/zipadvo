            ...
            <div className="lg:col-span-5 space-y-6">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Reach out via email, phone, or visit our liaison office in South Mumbai.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <Card className="border-slate-200 bg-white shadow-xs">
                  <CardContent className="p-5 flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-slate-900">Mumbai Chamber Liaison Office</h3>
                      <p className="text-xs text-slate-600 mt-1 leading-relaxed">
                        Fort Chambers, Nagindas Master Road, Fort, Mumbai, Maharashtra 400001
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-slate-200 bg-white shadow-xs">
                  <CardContent className="p-5 flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-slate-900">Operations & Technology Center</h3>
                      <p className="text-xs text-slate-600 mt-1 leading-relaxed">
                        The Capital, G-Block, Bandra Kurla Complex (BKC), Bandra East, Mumbai 400051
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-slate-200 bg-white shadow-xs">
                  <CardContent className="p-5 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">General Support: support@legalhubmumbai.com</p>
                      <p className="text-xs text-slate-600">Advocate Sanad Desk: verification@legalhubmumbai.com</p>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  {isSuccess ? (
                    <div className="p-6 rounded-xl bg-emerald-50 border border-emerald-200 text-center space-y-3 animate-in fade-in">
                      ...
                      <p className="text-sm text-emerald-700">
                        Thank you for contacting LegalHubMumbai. A member of our support team has been notified and
